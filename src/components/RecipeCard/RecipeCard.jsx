...
function RecipeCard({ recipe, setCurrentRecipe }) {
  return (
    <Col xs={8} md={6} lg={3} className='mx-auto mx-md-0 px-1' >
      <Nav.Link as={NavLink} to={`/${recipe._id}`}>
        <Card className='text-center border border-dark rounded my-3' style={{ maxHeight: '40vh' }} onClick={() => setCurrentRecipe(recipe)} >
